...
if __name__ == '__main__':
    ...
    with open('input.txt') as file:
        for line in file:
            ...
            for char in line:
                ...
                if char == 'L' or char == 'R':
                    xdelta = math.ceil((column_range[1] - column_range[0]) / 2) * (-1 if char == 'L' else 1)
                    column_range[1 if char == 'L' else 0] += xdelta
    ...
    seat_list = list(chain.from_iterable(seat_map))[50:-50]
    index = 0
